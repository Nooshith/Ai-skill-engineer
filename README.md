...
See the complete **Freelancer Marketplace** use case — a full 10-phase walkthrough with detailed artifacts, code samples, and terminal output:

> [📄 **docs/use-cases/freelancer-marketplace.md**](docs/use-cases/freelancer-marketplace.md)
